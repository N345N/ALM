<?php
$error_message = "";
$alert = "alert-info"; // Default alert class for general messages
...
if (isset($_GET['message'])) {
    ...
    if (strpos($error_message, 'Code has been sent') !== false) {
        $alert = "alert-info"; // Keep the info color for this message
    }
}
    ...
    if (isset($_POST['verify'])) {
        ...
        if (!empty($otp_code)) {
            ...
            if ($verifyQuery->num_rows > 0) {
                ...
                $alert = "alert-danger"; // Set alert class to danger for invalid OTP
            }
            ...
            $alert = "alert-danger"; // Set alert class to danger for empty OTP
        }
    }
}
?>
